...
pub struct InitializeTreasury <'info> {
    ...
    /// CHECK: This is going to be the mint authority for the x_mint tokens, it will never hold any tokens and will only be used as a signing PDA
...
pub struct BuyTokens <'info> {
    ...
    /// CHECK: This is the mint authority for the x_mint tokens
...
pub struct CloseProposal <'info> {
    ...
    /// CHECK: This is the destination account to receive the refunded tokens, it can be any account but we will require it to be a signer for security purposes
    #[account(mut)]
...
#[derive(Accounts)]
    ...
    ///The SOL vault PDA
    /// CHECK: This is a PDA that holds, validated by seeds
    #[account(
        mut,
        seeds = [b"sol_vault"],
