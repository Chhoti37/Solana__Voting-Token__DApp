...
const TreasuryInfo = ({ walletAddress, idlWithAddress, getProvider }) => {
    ...
    const fetchTreasuryInfo = async () => {
        ...
        //Only derive PDAs that are not started in the config
        ...
        const[solVaultPda] = PublicKey.findProgramAddressSync(
            ...
            //Try to fetch treasury config to check if finished
            try {
                ...
                setTreasuryInfo({
                    ...
                    tokenPerPurchase: treasuryAccountData.tokenPerPurchase.toString(),
                    isInitialized: true
                });
            } catch (e) {
