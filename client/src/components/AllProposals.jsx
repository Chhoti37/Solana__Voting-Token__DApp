...
const AllProposals = ({ walletAddress, idlWithAddress, getProvider }) => {
    ...
    const fetchAllProposals = async () => {
        ...
        try {
            ...
            // Use current Time - on devent/mainet this is synced with blockchain time
            const currentTime = Math.floor(Date.now() / 1000);

            // First get the proposal counter to know how many proposal exist
            ...
            try {
               ...
               setError('Proposal counter not initilized. Initilized treasury first.');
               setLoading(false);
               return;
            }
